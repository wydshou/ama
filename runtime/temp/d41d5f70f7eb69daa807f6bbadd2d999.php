<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"E:\WWW\ymx./app/index\view\home\editrole.html";i:1541044209;s:42:"E:\WWW\ymx\app\index\view\Public\base.html";i:1541144982;}*/ ?>
<!DOCTYPE html>
<html>
...
<!-- <style type="text/css">
	...
	<div class="content-page">
		...
		<form class="am-form am-form-horizontal" method="post" action="<?php echo url('Home/editrole'); ?>">
			<input type="hidden" name="group_id" value="<?php echo $rules['id']; ?>">
				  <div class="am-form-group">
			    <label for="doc-ipt-3" class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">角色名</label>
			    <div class="am-u-sm-9">
			      <input type="text" id="doc-ipt-3" value="<?php echo $rules['title']; ?>" name="roleName" placeholder="新添加角色名">
			    </div>
			  </div>
			 	 <div class="am-form-group">
			    <label for="doc-ipt-3" class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">角色描述</label>
			    <div class="am-u-sm-9">
			      <input type="text" id="doc-ipt-3" value="<?php echo $rules['description']; ?>" name="roledesc" placeholder="角色描述">
			    </div>
			  </div>
		<div class="row cl">
