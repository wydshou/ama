<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:48:"E:\WWW\ymx./app/index\view\Home\admini\edit.html";i:1541144424;s:42:"E:\WWW\ymx\app\index\view\Public\base.html";i:1541144982;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <!-- l栏目 -->
		...
		<div class="content-page">
			...
			<div class="am-g">
				<div class="am-u-md-6">
					<div class="card-box">
						<h4 class="header-title m-t-0 m-b-30">修改权限</h4>
			<form class="am-form am-form-horizontal" action="<?php echo url('Home/adminedit'); ?>" method="post">
				<div class="am-form-group">
					 <label for="doc-ipt-pwd-3" class="am-u-sm-3 am-form-label am-text-right am-padding-right-0">角色</label>
					<div class="am-u-sm-9">
						<span class="select-box">
						<select class="select" id="sel_Sub" name="group_id">
						<?php if(is_array($home_group) || $home_group instanceof \think\Collection || $home_group instanceof \think\Paginator): $i = 0; $__LIST__ = $home_group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($i % 2 );++$i;?>
							<option value="<?php echo $g['id']; ?>" <?php if($g['id'] == $group['group_id']): ?>selected="selected"<?php endif; ?>><?php echo $g['title']; ?></option>
						<?php endforeach; endif; else: echo "" ;endif; ?>
						</select>
						</span>
					</div>
				...
				<input type="hidden" name="aid" value="<?php echo $group['a_uid']; ?>">
