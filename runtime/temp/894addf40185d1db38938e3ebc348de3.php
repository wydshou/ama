<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"E:\WWW\ymx./app/common/view/public/error.tpl";i:1531989726;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <style type="text/css">
    	*{
		...
		.error_cont{
			...
			background:url(/public/static/image/warning.gif) 32px 32px no-repeat;
			line-height:1.8;
		}
		.error_return{
			padding:10px 0 0 0;
