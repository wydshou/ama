<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"E:\WWW\ymx./app/admin\view\system\homelist.html";i:1540965815;s:42:"E:\WWW\ymx\app\admin\view\Public\meta.html";i:1540801719;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<a class="btn btn-primary radius" onclick="system_category_add('添加栏目','<?php echo url('System/addhome'); ?>')" href="javascript:;"><i class="Hui-iconfont">&#xe600;</i> 添加栏目</a>
		</span>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
			<?php if(is_array($homemenu) || $homemenu instanceof \think\Collection || $homemenu instanceof \think\Paginator): $i = 0; $__LIST__ = $homemenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
				<tr class="text-c">
			...
			<?php if(isset($v['children'])): if(is_array($v['children']) || $v['children'] instanceof \think\Collection || $v['children'] instanceof \think\Paginator): if( count($v['children'])==0 ) : echo "" ;else: foreach($v['children'] as $key=>$mm): ?>
				<tr class="text-c">
					<td><input type="checkbox" name="" value=""></td>
					<td><?php echo $mm['id']; ?></td>
					<td><?php echo $mm['sort_order']; ?></td>
					<td class="text-l">&nbsp;&nbsp;├&nbsp;<?php echo $mm['title']; ?></td>
			...
			<?php if(isset($mm['children'])): if(is_array($mm['children']) || $mm['children'] instanceof \think\Collection || $mm['children'] instanceof \think\Paginator): if( count($mm['children'])==0 ) : echo "" ;else: foreach($mm['children'] as $key=>$mmm): ?>
				<tr class="text-c">
					<td><input type="checkbox" name="" value=""></td>
					<td><?php echo $mmm['id']; ?></td>
					<td><?php echo $mmm['sort_order']; ?></td>
					<td class="text-l">&nbsp;&nbsp;├&nbsp;├&nbsp;<?php echo $mmm['title']; ?></td>
					<td class="f-14"><a title="编辑" href="javascript:;" onclick="system_category_edit('栏目编辑','system-category-add.html','2','700','480')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
						<a title="删除" href="javascript:;" onclick="system_category_del(this,'2')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
